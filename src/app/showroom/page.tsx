    ...
    <div className="flex flex-col">
      ...
      <section className="relative py-32 bg-gray-950 text-white overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          <p className="text-xs tracking-[0.3em] text-gray-500 uppercase mb-8">Flagship Showroom</p>
          <h1 className="text-5xl md:text-6xl font-serif font-bold mb-4">
            成都旗舰展厅
          </h1>
          <p className="text-xl text-gray-400">
            CHENGDU FLAGSHIP SHOWROOM
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <p className="text-xs tracking-[0.2em] text-gray-400 uppercase mb-6">Overview</p>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.2em] text-gray-400 uppercase mb-6">Interior Styles</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-8 border border-gray-100">
                <div className="text-xs text-gray-400 mb-3">STYLE 0{i + 1}</div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">{style.title}</h3>
                <p className="text-gray-500 text-sm leading-relaxed">{style.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.2em] text-gray-400 uppercase mb-6">Experience</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: "", title: "光影美学", desc: "随季节与时间变化的自然光影" },
              { icon: "☕", title: "饮品服务", desc: "零食饮料供应，舒适洽谈空间" },
              { icon: "🧵", title: "面料体验", desc: "布艺面料实物触摸与选择" },
              { icon: "👥", title: "互动活动", desc: "定期举办人群互动活动" },
            ].map((item, i) => (
              <div key={i} className="text-center p-8 border border-gray-100 rounded-2xl">
      ...
      <section className="py-24 bg-gray-950 text-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.2em] text-gray-500 uppercase mb-6">Location</p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-8 border border-gray-800 rounded-2xl">
              ...
              <p className="text-gray-400 text-sm">成都太古里<br />新南路40号院</p>
            </div>
            <div className="p-8 border border-gray-800 rounded-2xl">
              <div className="text-3xl mb-4">🚇</div>
              <h3 className="font-semibold mb-2">交通</h3>
              <p className="text-gray-400 text-sm">地铁新南门站<br />D口步行可达</p>
            </div>
            <div className="p-8 border border-gray-800 rounded-2xl">
              <div className="text-3xl mb-4">️</div>
              <h3 className="font-semibold mb-2">停车</h3>
              <p className="text-gray-400 text-sm">楼下独立停车场<br />100个车位</p>
            </div>
          </div>
