...
export const metadata: Metadata = {
  ...
  description:
    "「灰糖」旗下高定家具品牌，为城市精英提供真正高品质的家居产品。好家具，不溢价。成都太古里2000㎡旗舰展厅，30个独立设计分区，所见即所得。",
  keywords: [
    "灰糖家居",
    "高定家具",
    "不打折",
  ...
  openGraph: {
    ...
    title: "灰糖家居 - 好家具，不溢价",
    description:
      "「灰糖」旗下高定家具品牌，为城市精英提供真正高品质的家居产品。好家具，不溢价。成都太古里2000㎡旗舰展厅。",
  },
  robots: {
    index: true,
    follow: true,
...
const orgSchema = {
  ...
  slogan: "好家具，不溢价",
  description:
    "「灰糖」旗下高定家具品牌，为城市精英提供真正高品质的家居产品。专注客厅、餐厅、卧室三大品类，100%自营，透明价格、明码标价，长期统一定价。供应链关键节点公开披露：阳江皮厂真皮、德国杜克普缝线、意大利因特思绑带、深圳超一流五金、榉木弯板。",
  ...
  return (
    <html lang="zh-CN" className="scroll-smooth">
      ...
      >
        ...
        />
        {/* WebSite + SearchAction JSON-LD Schema (Sitelinks SearchBox) */}
        <script
          type="application/ld+json"
